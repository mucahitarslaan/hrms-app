...
public class CSDExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CSDDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new CSDStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CSDDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CSDDateTimeConverter dateTimeConverter = new CSDStandardDateTimeConverter();

    public CSDExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CSDExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CSDMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CSDHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CSDExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CSDHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
