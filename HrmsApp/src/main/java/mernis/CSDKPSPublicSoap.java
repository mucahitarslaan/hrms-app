...
public class CSDKPSPublicSoap
{
    ...
    public CSDKPSPublicSoap(){}

    public CSDKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CSDKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CSDExtendedSoapSerializationEnvelope envelope= new CSDExtendedSoapSerializationEnvelope(CSDExtendedSoapSerializationEnvelope.VER11);
